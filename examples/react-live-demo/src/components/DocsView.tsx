...
export function DocsView() {
  ...
  return (
    <div style={{ color: '#fff', lineHeight: 1.6, animation: 'fade-in 0.4s ease both' }}>
      ...
      {/* ═══ Hero ═══ */}
      <section style={{ marginBottom: 48, paddingBottom: 40, borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
          <span style={{ fontSize: '0.6875rem', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#555', fontFamily: "'JetBrains Mono', monospace" }}>
            Developer Documentation
          </span>
        </div>
        <h2 style={{ fontSize: '2rem', fontWeight: 800, letterSpacing: '-0.03em', marginBottom: 12 }}>
          Integrate Normy in minutes.
        </h2>
        <p style={{ color: '#aaa', fontSize: '0.9375rem', maxWidth: 560 }}>
          Add AI-powered semantic validation to any form field. Get structured quality scores, feedback, and improvement suggestions — not just pass/fail.
        </p>
      </section>
...
X-Session-Id: optional-session-tracking-id`}
  ...
  "exampleAnswer": "The pricing was out of..."
      ...
      <section style={{ marginBottom: 48, paddingTop: 32, borderTop: '1px solid rgba(255,255,255,0.08)' }}>
      ...
      <section style={{ marginBottom: 20, paddingTop: 32, borderTop: '1px solid rgba(255,255,255,0.08)' }}>
        <h3 style={{ fontSize: '1.25rem', fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>
